...
function generateSpec() {
  ...
  return {
    ...
    paths: {
      ...
      '/devices/{id}/reboot': { post: { tags: ['Devices'], summary: 'Reboot a device via its driver/type mechanism (202; 422 when unsupported)', operationId: 'rebootDevice', security: [{ bearerAuth: [] }], parameters: [idParam()], responses: r200('reboot dispatch result: { method, status, detail }') } },
