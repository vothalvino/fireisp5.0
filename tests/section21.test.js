...
jest.mock('../src/middleware/rateLimit', () => ({
  ...
  verifyEmailResendLimiter: (req, res, next) => next(),
  bulkEmailLimiter: (req, res, next) => next(),
  emailSettingsTestLimiter: (req, res, next) => next(),
  portalPasswordResetLimiter: (req, res, next) => next(),
