...
SELECT NULL, 'send_payment_reminders', 'Send payment due and overdue reminder notifications', '0 * * * *', TRUE, 'normal'
FROM DUAL
WHERE NOT EXISTS (
    SELECT 1 FROM scheduled_tasks
    WHERE task_name = 'send_payment_reminders' AND organization_id IS NULL
);
