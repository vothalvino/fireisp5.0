-- Migration: 050_create_outages_table
-- Description: Planned and unplanned outage log. Tracks network-wide events
--              affecting many clients at once — per site and/or device with
--              start/end times, affected client count, root cause, and
--              resolution status. Feeds into SLA reporting and can trigger
