...
- [Invoice sequence and payment methods](invoice-sequence-and-payment-methods.md) — migration 381: atomic per-org invoice sequence replaces COUNT(*)+1; payments.payment_method enum aligned to DB (OXXO/SPEI/CoDi); PR #389; next migration: 382
