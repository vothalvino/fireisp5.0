...
- [Network authz hardening](network-authz-hardening.md) — plan/FK org-scoping (planAvailability.js) + RADIUS status lifecycle on suspend/terminate/cancel; flags bulk-suspend and service-order fillable-bypass as unfixed related gaps
