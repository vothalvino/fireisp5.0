...
const styles = {
  ...
  subject: { margin: '0 0 0.25rem', fontSize: '1.3rem', color: '#111827' },
  meta: { margin: 0, color: '#6b7280', fontSize: '0.85rem' },
  ...
  description: { background: '#f9fafb', borderRadius: 6, padding: '1rem', marginBottom: '1rem' },
  descText: { margin: 0, color: '#374151', fontSize: '0.9rem', lineHeight: 1.6, whiteSpace: 'pre-wrap' as const },
  sectionTitle: { fontSize: '1rem', color: '#374151', margin: '1rem 0 0.5rem', borderTop: '1px solid #f3f4f6', paddingTop: '1rem' },
  noComments: { color: '#9ca3af', fontSize: '0.875rem' },
  ...
  commentMeta: { color: '#6b7280', fontSize: '0.78rem', marginBottom: '0.25rem' },
  commentBody: { margin: 0, color: '#1e3a5f', fontSize: '0.9rem', lineHeight: 1.6, whiteSpace: 'pre-wrap' as const },
  replyForm: { marginTop: '1.25rem', borderTop: '1px solid #f3f4f6', paddingTop: '1rem', display: 'flex', flexDirection: 'column' as const, gap: '0.5rem' },
  replyTitle: { margin: 0, fontSize: '0.95rem', color: '#374151' },
  errorTxt: { color: '#b91c1c', fontSize: '0.875rem', margin: 0 },
  textarea: { padding: '0.6rem 0.75rem', border: '1px solid #d1d5db', borderRadius: 4, fontSize: '0.9rem', fontFamily: 'inherit', resize: 'vertical' as const, width: '100%', boxSizing: 'border-box' as const },
  ...
  closedNote: { marginTop: '1rem', color: '#6b7280', fontSize: '0.875rem', fontStyle: 'italic' as const },
} as const;
