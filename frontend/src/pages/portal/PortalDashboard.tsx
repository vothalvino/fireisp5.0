...
const styles = {
  ...
  viewAll: { fontSize: '0.85rem', color: 'var(--accent)', textDecoration: 'none' },
  ...
  payLink: { color: 'var(--accent)', fontWeight: 600, textDecoration: 'none' },
  ticketLink: { color: 'var(--link)', textDecoration: 'none' },
  newTicketBtn: {
