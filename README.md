...
- RESTful API with 457 REST API endpoints, interactive Swagger UI documentation (`/api/docs`), and static OpenAPI spec (`docs/openapi.json`)
...
│   └── migrations/          # Individual numbered migration files (001–312)
