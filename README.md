...
- RESTful API with 310 endpoints, interactive Swagger UI documentation (`/api/docs`), and static OpenAPI spec (`docs/openapi.json`)
...
│   ├── schema.sql           # Combined schema (all 238 tables + column additions)
│   └── migrations/          # Individual numbered migration files (001–294)
...
> **Migration 296 — Customer Self-Service Portal RBAC Permissions Seed (§11):** `296_seed_portal_self_service_permissions.sql` seeds 8 permissions in the `portal` module: `portal_kb.view/create/update/delete` (4 — admin-side KB management), `portal_service_requests.view/update` (2 — admin review and approval of client requests), `portal_push.view/manage` (2 — Web Push dispatch). Role matrix: admin (all 8), technician (6: KB view/create/update, service_requests view/update, push view), readonly (3 view permissions).
