...
- RESTful API with 712 REST API endpoints, interactive Swagger UI documentation (`/api/docs`), and static OpenAPI spec (`docs/openapi.json`)
...
│   ├── schema.sql           # Combined schema (all 265 tables + column additions)
│   └── migrations/          # Individual numbered migration files (001–313)
