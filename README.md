...
│   ├── schema.sql           # Combined schema (all 325 tables + column additions)
│   └── migrations/          # Individual numbered migration files (001–383)
