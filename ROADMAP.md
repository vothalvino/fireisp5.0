...
| 2026-04-22 | 4.1 | IP allowlist for admin endpoints: ipAllowlist middleware (IPv4 + CIDR, IPv4-mapped IPv6, opt-in via ADMIN_IP_ALLOWLIST); applied to organizations, users, roles, settings, audit-logs, scheduled-tasks, import, billing routes; .env.example + deployment.md updated; 45 new Jest tests | #TBD |
